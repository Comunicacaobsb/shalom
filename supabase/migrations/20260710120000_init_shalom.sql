-- =====================================================================
--  Migração inicial — Comunidade Shalom Brasília (repo-wide, escopo por site)
--  Aplicada automaticamente pelo Supabase a cada push na branch de produção
--  (integração GitHub + "Deploy to production" ligado).
...
-- =====================================================================
--  RLS — visitante LÊ (publicados + configs); só logado ESCREVE
-- =====================================================================
...
-- =====================================================================
--  STORAGE — bucket público das artes (arquivos com prefixo do site)
-- =====================================================================
